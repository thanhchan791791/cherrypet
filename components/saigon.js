function Saigon() {
    ...
    if (!document.getElementById("sg-style")) {
      ...
      style.innerHTML = `
        ...
        .sg-btn {
          ...
          overflow: hidden;
          position: relative;
          min-height: 60px; /* chiều cao nút lớn */
          opacity: 0;
        ...
        /* Nút "Chọn chi nhánh khác" tách riêng */
        .sg-btn-branch {
          grid-column: 1 / -1;
          flex-direction: row;
          min-height: 20px; /* giảm còn 1/3 của 60px */
        ...
        /* CHỈNH LẠI PHẦN ICON CHO CHI NHÁNH KHÁC */
        .sg-btn-branch .sg-btn-icon {
          width: 24px;     /* cố định kích thước icon */
          height: 24px;
          flex: 0 0 auto;  /* không co giãn */
          margin-right: 10px;
        }
        .sg-btn-branch .sg-btn-icon img {
          width: 100%;
          height: 100%;
          object-fit: contain;
        }
        .sg-btn-branch .sg-btn-text-overlay {
          position: static;
          transform: none;
          padding: 0;
          background: none;
        ...
        @media (max-width: 640px) {
          ...
          /* Nút đổi chi nhánh to hơn trên mobile */
          .sg-btn-branch {
            min-height: 40px;  /* tăng từ 30px lên 40px */
          }
          .sg-btn-branch .sg-btn-icon {
            width: 48px;       /* tăng từ 28px lên 48px */
            height: 48px;
          }
          .sg-btn-branch .sg-btn-icon img {
            width: 100%;
  ...
  // Giữ nguyên hàm loadComponent của bạn
  // Bạn nhớ kiểm tra loadComponent khi "app" có giữ lại body class và container nhé
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      "Hãy chọn loại thú cưng bạn muốn xem 🐶🐱"
    ),
    React.createElement(
      "div",
      { className: "sg-grid" },
